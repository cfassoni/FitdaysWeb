...
export default function LanguageSelector({ variant = "sidebar", isCollapsed = false }: LanguageSelectorProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={`absolute bottom-full mb-2 w-48 bg-card border border-border rounded-xl shadow-xl py-1.5 animate-in fade-in slide-in-from-bottom-2 duration-150 z-50 ${
