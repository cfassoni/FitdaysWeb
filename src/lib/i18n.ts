...
const COOKIE_NAME = "recomp_pro_lang";
...
export function detectLanguage(): SupportedLanguage {
  ...
  return resolveLanguage(cookieLang, navLang);
}
...
export function formatDate(date: Date | string | null | undefined, options?: Intl.DateTimeFormatOptions): string {
  ...
  return d.toLocaleDateString(i18n.language || "en", options || {
    month: "short",
    day: "numeric",
    year: "numeric",
  });
...
export function formatDateTime(date: Date | string | null | undefined, options?: Intl.DateTimeFormatOptions): string {
  ...
  return d.toLocaleString(i18n.language || "en", options || {
    weekday: "short",
    year: "numeric",
    month: "short",
    day: "numeric",
