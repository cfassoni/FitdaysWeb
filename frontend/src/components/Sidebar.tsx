    ...
    <>
        ...
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          <div className="relative flex flex-col w-72 max-w-xs bg-card border-r border-border h-full p-6 shadow-xl animate-in slide-in-from-left duration-200">
            ...
            <div className="border-t border-border pt-4 mt-auto space-y-4">
              ...
              <div className="flex items-center justify-center gap-2 pt-2 border-t border-border/50 text-muted-foreground/60 text-xs">
                <a 
                  href="https://github.com/cfassoni/FitdaysWeb" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-foreground transition-colors inline-flex items-center gap-1.5"
                  title="FitdaysWeb GitHub Repository"
                >
      ...
      >
        ...
        <div className="p-4 border-t border-border space-y-3">
          ...
          <div className="flex items-center justify-center gap-2 pt-2.5 border-t border-border/50 text-muted-foreground/60 text-xs">
            <a 
              href="https://github.com/cfassoni/FitdaysWeb" 
              target="_blank" 
              rel="noopener noreferrer"
