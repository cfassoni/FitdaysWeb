    ...
    t: (key: string) => {
      const map: Record<string, string> = {
        ...
        "forgotPassword.successMessage":
          "If an account exists with that email, a password reset link and 6-digit code have been sent.",
...
describe("ForgotPassword View", () => {
  ...
  it("submits forgot password request and shows check email success state", async () => {
    ...
    render(<ForgotPassword onGoToLogin={mockOnGoToLogin} onGoToReset={mockOnGoToReset} />);
